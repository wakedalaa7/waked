                                ...
                                <div className="container border-radius-lg">
                                    <div className="row">
                                        ...
                                        <div className="col-3 py-3 ps-0">
                                            ...
                                            <div className="progress w-75">
                                                <div className="progress-bar bg-dark w-90" role="progressbar" aria-valuenow={60} aria-valuemin={0} aria-valuemax={100}></div>
                                            </div>
                                        </div>
                                        <div className="col-3 py-3 ps-0">
                                            <div className="d-flex mb-2">
                                            ...
                                            <div className="progress w-75">
                                                <div className="progress-bar bg-dark w-30" role="progressbar" aria-valuenow={60} aria-valuemin={0} aria-valuemax={100}></div>
                                            </div>
                                        </div>
                                        <div className="col-3 py-3 ps-0">
                                            <div className="d-flex mb-2">
                                            ...
                                            <div className="progress w-75">
                                                <div className="progress-bar bg-dark w-50" role="progressbar" aria-valuenow={60} aria-valuemin={0} aria-valuemax={100}></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
